    ...
    return (
        <section id="hero" className="container-box space-y-14 pt-10 md:pt-32">
            <motion.div className="text-center space-y-5 md:space-y-8 w-max mx-auto" {...anim({ duration: 1, delay: 0 })} >
                <p className="font-roboto-slab">Perayaan 57 tahun kebersamaan kami</p>
                <h1 className="heading-4 md:heading-2 lg:heading-1 font-dancing-script font-bold md:font-normal">Ati & Wicak</h1>
